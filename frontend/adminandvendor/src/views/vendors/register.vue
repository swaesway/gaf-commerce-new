...
function createVendorAccount(){
  ...
  const { shopname, email, telephone, location, region, proof_of_business, password, password_confirmation} = form;
                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  <div class="card mb-3">
                    <div class="card-body">
                      ...
                      <form class="row g-3 needs-validation" @submit.prevent="createVendorAccount" enctype="multipart/form-data">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                          <label for="proof_of_business" class="form-label">upload Proof Of Business</label>
                        ...
                        <div class="col-12">
                      <p class="small mb-0">Already have an account? <router-link to="/vendor/login">Log in</router-link></p>
                    </div>
                      </form>
                    </div>
                  </div>
