...
const {products, getVendorProductById , editProduct } = productStore();
...
function uploadProduct() {
  ...
  editProduct(data, product.images, route.query?.product, router);
}
...
watchEffect(() => {
  product.title = products.singleProduct.title || "";
  product.price = products.singleProduct.price || "";
  product.category = products.singleProduct.category || "";
  product.description = products.singleProduct.description || "";

   if (quillEditor.value && products.singleProduct.description) {
    quillEditor.value.root.innerHTML = products.singleProduct.description;
  }
});
...
onBeforeMount(() => {
    getVendorProductById(route.query?.product);
            ...
            <div class="card add-product-card">
              ...
              <form class="form-card" @submit.prevent="uploadProduct">
                ...
                <div class="row justify-content-center text-center">
                  <div class="col-sm-6">
                    <button v-if="products.isLoading"
                      type="submit"
